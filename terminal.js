    ...
    const commands = {
        ...
        'credits': {
                execute: () => {
                    ...
                    'Main site theme by Bootsrap<br><br>' +
                    'PC sound by Eleven';
        ...
        'sick': {
            execute: () => {
                audio = new Audio('Sounds/sick.mp3');
                audio.play();
            },
            hidden: true
        },
...
//?https://chat.openai.com/c/471cfa9b-808a-48f9-b81e-76c8e95a5665
//?Special martlet theme
    ...
    if (commands[command]) {
        ...
        typoerror = new Audio('/Sounds/TerminalTypoError.ogg');
        typoerror.play();
    }
        linecount++;
    }
